            ...
            <div className="p-4 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-4">
              ...
              <div className="flex items-center gap-3.5 pb-3 border-b border-slate-800/60">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {/* Compte Google connecté : affiché sur une SEULE et même ligne */}
                  <div className="flex items-center gap-2 mt-1 text-xs text-slate-300 truncate">
                    <span className="text-slate-400 shrink-0 flex items-center gap-1.5 font-medium">
                    ...
                    <span className="font-mono text-cyan-400 font-semibold truncate">{displayEmail}</span>
                  </div>
